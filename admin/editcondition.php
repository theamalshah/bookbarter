...
$id=$_GET['id'];
$qry = "SELECT * FROM condition_table WHERE  id=$id";
            ...
            <div class="panel-body">
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" border=2 id="dataTables-example">
                      <form action="conditionupdateprocess.php" method="GET">
                        ...
                        <thead>
                            ...
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                              ...
                              <td><input type="text" name="condition_name" value="<?php echo $row['condition_name'];?>"></td>
                              </tr>
                              <tr>
                            <td>
