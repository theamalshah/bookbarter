...
$qry = "SELECT id, city_name, is_active FROM city_table WHERE is_active!=2";
                        ...
                        <div class="panel-body">
                            ...
                            ?>
                                <tbody>
                                    ...
                                    <td><a href="actioncity.php?id=<?php echo $row['id']; ?>&status=<?php echo $row['is_active']; ?>">Change</a></td>
