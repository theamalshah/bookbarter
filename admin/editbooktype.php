...
$id=$_GET['id'];
$qry = "SELECT * FROM booktype_table WHERE  id=$id";
            ...
            <div class="panel-body">
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" border=2 id="dataTables-example">
                      <form action="booktypeupdateprocess.php" method="GET">
                        ...
                        <thead>
                            ...
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                              ...
                              <td><input type="text" name="booktype_name" value="<?php echo $row['booktype_name'];?>"></td>
                              </tr>
                              <tr>
                            <td>
